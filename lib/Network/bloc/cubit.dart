...
import 'package:weather_task2/Network/api/end_points.dart';
...
class WeatherCubit extends Cubit<WeatherState> {
  ...
  AddAnotherLocation(city, temp) {
    ...
    CacheHelper.setData(key: "locations", value: locations);
    CacheHelper.setData(key: "temps", value: temps);
