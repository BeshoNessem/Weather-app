...
import 'package:weather_task2/Presentation/widgets/drawer/divider.dart';
import 'package:weather_task2/Presentation/widgets/drawer/drawer_tag.dart';
import 'package:weather_task2/Presentation/widgets/drawer/weather_tag.dart';
import 'package:country_state_city_picker/country_state_city_picker.dart';

buildMenu(String region, double temp_c, BuildContext context) {
  return Padding(
        ...
        child: Padding(
          ...
          child: Column(children: [
            ...
            (WeatherCubit.get(context).managemntBoardopened)
                ...
                : SizedBox(),
            const DottedDivider(),
            DrawerTag(iconData: Icons.report_outlined, text: "Report wrong location"),
            DrawerTag(iconData: Icons.headset_mic_outlined, text: "Contact us"),
          ]),
        ),
      ),
    ),
